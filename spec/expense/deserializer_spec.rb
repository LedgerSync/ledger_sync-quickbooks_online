...
RSpec.describe LedgerSync::QuickBooksOnline::Expense::Deserializer do
  ...
  let(:h) do
    {
      ...
      'DocNumber' => 'Ref123',
      'PaymentType' => LedgerSync::QuickBooksOnline::Expense::PAYMENT_TYPES[payment_type],
      ...
      'Line' => line_items.map do |line_item|
        LedgerSync::QuickBooksOnline::ExpenseLine::Serializer.new.serialize(
          resource: line_item
        )
      end
    }
  ...
  describe '#deserialize' do
    ...
    it do
      deserialized_resource = expect_deserialized_attributes(
        ...
        resource: LedgerSync::QuickBooksOnline::Expense.new,
        response_hash: h,
      ...
      expect(entity).to be_a(LedgerSync::QuickBooksOnline::Vendor)
