...
RSpec.describe LedgerSync::QuickBooksOnline::WebhookEvent do
  ...
  describe '#find_operation' do
    it do
      ...
      expect(op).to be_a(LedgerSync::QuickBooksOnline::Customer::Operations::Find)
    end
  end
  ...
  describe '#find_operation_class' do
    it do
      ...
      expect(op).to eq(LedgerSync::QuickBooksOnline::Customer::Operations::Find)
    end
  end
  ...
  describe '#resource' do
    it do
      expect(instance.resource).to be_a(LedgerSync::QuickBooksOnline::Customer)
    end

    it do
      payload['name'] = 'Vendor'
      expect(instance.resource).to be_a(LedgerSync::QuickBooksOnline::Vendor)
    end
  end
  ...
  describe '#resource_class' do
    it { expect(instance.resource_class).to eq(LedgerSync::QuickBooksOnline::Customer) }
    it do
      payload.merge!('name' => 'Vendor')
      expect(instance.resource_class).to eq(LedgerSync::QuickBooksOnline::Vendor)
    end
  end
end
