...
RSpec.describe LedgerSync::QuickBooksOnline::Serializer do
  ...
  let(:local_bill) do
    LedgerSync::QuickBooksOnline::Bill.new(
      line_items: [
        LedgerSync::QuickBooksOnline::BillLineItem.new(
          ledger_id: 1
        ),
        LedgerSync::QuickBooksOnline::BillLineItem.new(
  ...
  describe '#serialize' do
    it 'deep merges values' do
      serializer_class = LedgerSync::QuickBooksOnline::Customer::Serializer
      customer = LedgerSync::QuickBooksOnline::Customer.new(
        DisplayName: 'test',
